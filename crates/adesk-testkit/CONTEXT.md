...
- No test is `#[ignore]`d (a full run executes 66 tests, 0 failures); the doc-fence inventory is 3 `no_run` (`src/lib.rs:24`, `src/gate.rs:27`, `src/fixtures/mod.rs:75`) + 3 `ignore` + 5 `text`.

...
- Wire tags: `"hello"`, `"request_frame"`, `"request_state"`, `"pointer_move"`, `"pointer_button"`, `"scroll"`, `"key"`, `"text"`, `"activate_window"`, `"set_control"`, `"bye"`; server adds `"frame"`, `"state"`, `"control"`, `"input_ack"`, `"error"` (and reuses `"hello"`/`"bye"` in the other direction).
Types (`src/types.rs`):

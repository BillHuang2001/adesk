...
Per-file test counts (98 total, all plain sync `#[test]`; no `#[tokio::test]`, no `#[ignore]`):
`viewer.rs` 15, `accessibility.rs` 13, `notify.rs` 11, `observation.rs` 11, `protocol.rs` 11,

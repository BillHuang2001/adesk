...
- Internal: `adesk-core` (domain types, `RuntimeEvent`), `adesk-wm` (window model + policy) [WMDEPS], `adesk-render` (`Scene`/`create_target`/`render_scene`/readback/image conversion).
